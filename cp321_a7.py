...
app.layout = [
    ...
    html.H5(children='Dropdown to select country of interest for viewing their number of wins and years they won', style={'textAlign':'center'}),
    ...
    html.H5(children='Slider to change year for viewing winner and runner-up', style={'textAlign':'center'}),
    dcc.Slider(
        min=min(data["Year"]),
        max=max(data["Year"]),
        step=None,
